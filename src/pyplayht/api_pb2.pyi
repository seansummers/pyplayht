...
class TtsRequest(_message.Message):
    ...
    def __init__(
        self,
        lease: _Optional[bytes] = ...,
        params: _Optional[_Union[TtsParams, _Mapping]] = ...,
    ) -> None: ...
...
class TtsParams(_message.Message):
    ...
    def __init__(
        ...
        voice_guidance: _Optional[float] = ...,
        text_guidance: _Optional[float] = ...,
        other: _Optional[str] = ...,
    ) -> None: ...
...
class Status(_message.Message):
    ...
    def __init__(
        self,
        code: _Optional[_Union[Code, str]] = ...,
        message: _Optional[_Iterable[str]] = ...,
    ) -> None: ...
